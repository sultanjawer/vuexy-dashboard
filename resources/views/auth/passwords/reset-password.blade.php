                    ...
                    <div class="auth-inner my-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-reset-password-form mt-2" action="{{ route('reset.password') }}"
                                    method="POST">
                                    @csrf
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge"
                                                id="reset-password-new" name="reset_password_new"
                                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                aria-describedby="reset-password-new" tabindex="1" autofocus />
                                            <span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                        </div>

                                        @if (session()->has('reset_password_new'))
                                            <small class="text-danger">{{ session()->get('reset_password_new') }}</small>
                                        @endif
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge"
                                                id="reset-password-confirm" name="reset_password_confirm"
                                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                aria-describedby="reset-password-confirm" tabindex="2" />
                                            <span class="input-group-text cursor-pointer"><i
                                                    data-feather="eye"></i></span>
                                        </div>
                                        @if (session()->has('reset_password_confirm'))
                                            <small
                                                class="text-danger">{{ session()->get('reset_password_confirm') }}</small>
                                        @endif

                                    </div>
                                    <button type="submit" class="btn btn-primary w-100" tabindex="3">إعادة تعيين كلمة
                                        المرور</button>
                                </form>

                                <p class="text-center mt-2">
                                    <a href="{{ route('login') }}"> <i data-feather="chevron-left"></i> العودة لصفحة تسجيل
                                        الدخول
                                    </a>
                                </p>
                            </div>
