                        ...
                        <div class="col-md-6 mb-1 saee_prc" style="display: block;" wire:ignore.self>
                            ...
                            <div class="input-group input-group-merge">
                                <input type="number" class="form-control" step="0.01" min="0"
                                    ...
                                    wire:model='saee_prc'>
                                <span class="input-group-text">%</span>
                                <span class="input-group-text spinner-border spinner-border-sm" wire:loading
                ...
                <div class="account-details" style="display: none;" wire:ignore.self>
                    ...
                    <div class="row" wire:ignore>
                        ...
                        <div class="col-md-12 mb-1">
                            ...
                            <select wire:change="customerBuyerId('customer_buyer_id')" wire:model='customer_buyer_id'
                                class="select2 search-customer-buyer form-select">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-1">
                            ...
                            <input type="text" class="form-control"
                                wire:input.debounce.1s="customerIdType('customer_buyer_id_number')"
                ...
                <div class="account-home-details" style="display: none;" wire:ignore.self>
                    ...
                    <div class="row" wire:ignore>
                        ...
                        <div class="col-md-12 mb-1">
                            ...
                            <select wire:change="customerSellerId('customer_seller_id')"
                                wire:model='customer_seller_id' class="select2 search-customer-seller form-select">
                                @foreach ($customers as $customer)
                                    <option value="{{ $customer->id }}">
                                        {{ $customer->name . ' :: ' . $customer->phone . ' :: ' . $customer->nationality_id }}
                                    </option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-1">
                            <label class="form-label">رقم الهوية</label>
                            <input type="text" class="form-control "
                                wire:input.debounce.1s="customerIdType('customer_seller_id_number')"
